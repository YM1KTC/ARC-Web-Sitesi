...
slug: dmr-dijital-mobisle-radio-nedir
publishDate: 2025-04-07T00:00:31.000Z
author: TA1SPH
categories:
...
tags:
  ...
  - dmr nedir
  - dmr röle ve hotspot
image: ../../assets/images/blogs//dmr_dijital_mobisle_radio_nedir_image_cover.png
---
...
![D.M.R](../../assets/images/blogs//dmr_dijital_mobisle_radio_nedir_image_001.png)
...
![D.MR. Hot Spot](../../assets/images/blogs//dmr_dijital_mobisle_radio_nedir_image_002.png)
*Örnek D.M.R. HotSpot*
...
## **ARC DMR Kanal Listeleri**

ARC Derneği olarak çeşitli cihazlara yönelik hazır DMR kanal listeleri (CSV) sunuyoruz. Türkiye’deki DMR röleleri ve Talkgroup’ları içeren bu dosyaları doğrudan telsizinize aktarabilirsiniz. Desteklenen cihazlar ve indirme linkleri için **[dmr.radio.org.tr](https://dmr.radio.org.tr/)** adresini ziyaret edin.

## **Sonuç**

DMR, amatör telsizciler için dijital haberleşme dünyasına açılan önemli bir kapıdır. Röleler, hotspot’lar ve Talkgroup’lar sayesinde dünya genelinde telsiz kullanıcıları ile iletişim kurma fırsatı sunar. Eğer henüz DMR dünyasına adım atmadıysanız, temel bir DMR telsizi edinip bir DMR ID alarak ve **[dmr.radio.org.tr](https://dmr.radio.org.tr/)** adresinden cihazınıza uygun kanal listesini indirerek bu dijital iletişim ağına katılabilirsiniz.
